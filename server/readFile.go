...
// set the input file to extract the number of ants, rooms, and tunnels.
func ReadFile(filepath string) string {
	...
	if Start == "" || End == "" || Start == End {
		return "ERROR: invalid data format, Start or End room not found, or share one room"
	}
